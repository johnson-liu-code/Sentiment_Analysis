...
def data_preprocessing(
    ...
    print("Generating unique words and co-occurrence matrix using the most frequent {max_vocab_size} words...")
    ...
    unique_words, cooc_matrix_sparse = (
        functions.helper_functions.cooccurrence_matrix.create_cooccurrence_matrix_sparse(
            filtered_comments,
            window_size,
            max_vocab_size
        )
    ...
    cooc_prob_matrix_sparse = cooccurrence_probability_sparse(cooc_matrix_sparse)
    ...
    return unique_words, cooc_matrix_sparse, cooc_prob_matrix_sparse, filtered_comments, filtered_labels
